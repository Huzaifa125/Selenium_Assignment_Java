...
import static pages.AutomationTestStore.dashboardpage.DashboardPage.*;
import static pages.AutomationTestStore.dashboardpage.DashboardPageLocators.quantity_TXT;
import static pages.AutomationTestStore.dashboardpage.DashboardPageLocators.unitPrice_TXT;
...
public class TaskFourTests extends BaseTest {
    ...
    public void totalItemCountAndAmountUsingEuroTest() {
        ...
        pages.AutomationTestStore.loginpage.LoginPage loginPage = new LoginPage(getDriver());
